...
<st:form action="mylogin" cssClass="form">
<st:textfield input="Email" placeholder="Email" name="uemail" cssClass="form__input" ></st:textfield>
<st:textfield input="Password" type="password" placeholder="Password" name="upass" cssClass="form__input" ></st:textfield>
<st:submit  cssClass="btn" value="Login"></st:submit>
</st:form>

 <div class="container-register">
    <p>Don't have an account? <a class="register" href="register.jsp">Register</a>.</p>
